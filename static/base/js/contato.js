...
const ytSquare = document.querySelector('.yt-square')
const igSquare = document.querySelector('.ig-square')
const linkedinSquare = document.querySelector('.linkedin-square')
const tiktokSquare = document.querySelector('.tiktok-square')
const twitterSquare = document.querySelector('.twitter-square')
const igIframe = document.querySelector('#instagram')
const tiktokIframe = document.querySelector('#tiktok')
const linkedinIframe = document.querySelector('#linkedin')
const twitterIframe = document.querySelector('#twitter')
const ytIframe = document.querySelector('#youtube')
...
linkedin_contato.addEventListener("click", function()
{
  ytIframe.style.display = 'none'
  twitterIframe.style.display = 'none'
  tiktokSquare.style.display = 'none'
  tiktokIframe.style.display = 'none'
  igIframe.style.display = 'none'
  igSquare.style.display = 'none'
  twitterSquare.style.display = 'none'
  ytSquare.style.display = 'none'
  linkedinSquare.style.display = 'flex'
  linkedinIframe.style.display = 'flex'
});  

tiktok_contato.addEventListener("click", function()
{

  ytIframe.style.display = 'none'
  twitterIframe.style.display = 'none'
  tiktokSquare.style.display ='flex'
  tiktokIframe.style.display = 'flex'
  igIframe.style.display = 'none'
  igSquare.style.display = 'none'
  twitterSquare.style.display = 'none'
  ytSquare.style.display = 'none'
  linkedinSquare.style.display = 'none'
  linkedinIframe.style.display = 'none'
});

youtube_contato.addEventListener("click", function()
{
  ...
  igSquare.style.display = 'none'
  twitterSquare.style.display = 'none'
  ytSquare.style.display = 'flex'
  linkedinSquare.style.display = 'none'
  linkedinIframe.style.display = 'none'

})

instagram_contato.addEventListener("click", function() {
  ...
  linkedinSquare.style.display = 'none'
  linkedinIframe.style.display = 'none'
  igIframe.style.display = 'flex'
  igSquare.style.display = 'flex'
})
...
twitter_contato.addEventListener("click", function(event)
{
  ...
  ytIframe.style.display = 'none'
  twitterIframe.style.display = 'flex'
  tiktokSquare.style.display = 'none'
  tiktokIframe.style.display = 'none'
  igIframe.style.display = 'none'
  igSquare.style.display = 'none'
  twitterSquare.style.display = 'flex'
  ytSquare.style.display = 'none'
  linkedinSquare.style.display = 'none'
  linkedinIframe.style.display = 'none'
